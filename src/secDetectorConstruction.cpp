...
//SiPM
    ...
    new G4PVPlacement(0, 
                      G4ThreeVector(0., 0., 4.*cm- Scint_Size[2] - SiPM_Size[2]),
                      pm_log1, 
                      "SiPM1", 
                      world_log, 
                      false, 
...
//Aluminium Foil
    ...
    new G4PVPlacement(0, G4ThreeVector(0., 0.,  4.*cm), foil_log1, "Al_foil_phy1", world_log, false, 0, OverLapCheck);
    new G4PVPlacement(0, G4ThreeVector(0., 0., -4.*cm), foil_log2, "Al_foil_phy2", world_log, false, 0, OverLapCheck);
