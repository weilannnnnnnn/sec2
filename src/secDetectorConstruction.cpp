...
//Detector
    ...
    new G4PVPlacement(0, G4ThreeVector(0., 0.,  3.*cm), sci_log1, "sci_phy1", world_log, false, 1, OverLapCheck);
    new G4PVPlacement(0, G4ThreeVector(0., 0., -3.*cm), sci_log2, "sci_phy2", world_log, false, 2, OverLapCheck);
//=======================================================================
...
{
    std::vector<G4String> HCnameVect = {"Upper Photon HC", "Lower Photon HC", "Upper Muon HC", "Lower Muon HC"};
    auto ScintSD = new secScintSD("ScintSD", HCnameVect);
